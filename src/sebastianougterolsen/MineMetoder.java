...
class MineMetoder {
    ...
    public void altMuligt() {
        ...
        //Anvendelse af Class Date, bare fordi.
...
//random=7; Brugt til debuggin

        //Jeg laver et Scanner-objekt til input fra brugeren og udskriver hvor mange input brugeren kan foretage
        Scanner input = new Scanner(System.in);
        System.out.println("Indtast " + (mitArray.length - random) + " integer værdi(er) herunder:"); //Antal indexes angives med .length & -random for at få et tilfældigt input



                //Jeg laver et for-loop, der initialiserer array'et med brugerinputtet
                ...
                // Et for-loop, der printer hvert element i vores array
                for (int i = 0; i < mitArray.length - random; i++) //Hvis "i" er mindre end antallet af indexes i array køres loopet
                ...
                //Jeg laver et nyt for-loop, der initialiserer array'et med brugerinputtet
                for (int i = mitArray.length - random; i < mitArray.length; i++) //Hvis "i" er mindre end antallet af indexes i array køres loopet
                    mitArray[i] = input.nextInt(); //Tildeler i-værdien til "mitArray"

                // Et nyt for-loop, der printer hvert element i vores array efter de første
                for (int i = 0; i < mitArray.length; i++) //Hvis "i" er mindre end antallet af indexes i array køres loopet
                    System.out.print(mitArray[i] + " "); //"mitArray[i]" er naturligvis den værdi loopet initialiserer indexet
        System.out.println("\n Nu har vi et fyldt Array");
            }
        }
